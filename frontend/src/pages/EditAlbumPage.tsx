...
export default function EditAlbumPage() {
  ...
  if (error && !album) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 text-center">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Unable to load album</h3>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Album</h1>
        <p className="text-gray-600 dark:text-gray-300">Update your album details and images</p>
      </div>
